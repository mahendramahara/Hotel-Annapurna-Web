...
<div class="staff-container">
    ...
    <div class="staff-table-container">
        ...
        <div class="pagination">
            <?php if($page > 1): ?>
                <a href="?page=staffs&p=<?= $page-1 ?>" class="page-btn">Previous</a>
            <?php endif; ?>
            
            <?php for($i = 1; $i <= $total_pages; $i++): ?>
                <a href="?page=staffs&p=<?= $i ?>" class="page-btn <?= $i == $page ? 'active' : '' ?>"><?= $i ?></a>
            <?php endfor; ?>
            
            <?php if($page < $total_pages): ?>
                <a href="?page=staffs&p=<?= $page+1 ?>" class="page-btn">Next</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
