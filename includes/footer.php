<footer class="main-footer">
    <div class="footer-container">
        ...
        <div class="footer-column">
            <h2>Contact Us</h2>
            <p><ion-icon name="location"></ion-icon> Durbarmarg, Kathmandu, Nepal</p>
            <p><ion-icon name="call"></ion-icon> +977-123-456789</p>
            <p><ion-icon name="mail"></ion-icon> <a href="mailto:info@hotelannapurna.com">info@hotelannapurna.com</a></p>
        </div>
    </div>

    <div class="footer-bottom">
        <p>&copy; 2025 Hotel Annapurna. All rights reserved.</p>
        <p>Developed by <a href="https://www.mahendrasingh.com.np/" target="_blank">Mahendra Mahara</a></p>
    </div>
    <!-- Scroll to Top -->
